...
},{"../utils/console":30,"decorator-cache-getter":1,"versioning":36}],4:[function(require,module,exports){
...
},{"../utils/console":30,"../utils/native-wait":32,"decorator-cache-getter":1,"timers":35,"versioning":36}],5:[function(require,module,exports){
"use strict";
...
},{"./api":3,"./base":4,"./filtering":5,"./runtime":7,"./structs/array":8,"./structs/assembly":9,"./structs/class":10,"./structs/domain":11,"./structs/field":12,"./structs/gc":14,"./structs/gc-handle":13,"./structs/image":15,"./structs/memory-snapshot":16,"./structs/method":17,"./structs/object":18,"./structs/parameter":19,"./structs/pointer":20,"./structs/reference":21,"./structs/string":22,"./structs/thread":23,"./structs/type":25,"./structs/type-enum":24,"./structs/value-type":26,"./tracer":27}],7:[function(require,module,exports){
"use strict";
...
},{"decorator-cache-getter":1}],8:[function(require,module,exports){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"decorator-cache-getter":1}],9:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"../../utils/utils":33,"decorator-cache-getter":1}],10:[function(require,module,exports){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"../../utils/utils":33,"decorator-cache-getter":1}],11:[function(require,module,exports){
"use strict";
...
},{"../../utils/utils":33,"decorator-cache-getter":1}],12:[function(require,module,exports){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"../utils":28,"decorator-cache-getter":1}],13:[function(require,module,exports){
"use strict";
...
},{"versioning":36}],15:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"../../utils/utils":33,"decorator-cache-getter":1}],16:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"../../utils/utils":33,"decorator-cache-getter":1}],17:[function(require,module,exports){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"../../utils/utils":33,"../utils":28,"decorator-cache-getter":1}],18:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"decorator-cache-getter":1}],19:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"../utils":28}],21:[function(require,module,exports){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"../utils":28}],22:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31}],23:[function(require,module,exports){
(function (setImmediate){(function (){
"use strict";
...
},{"../../utils/console":30,"../../utils/native-struct":31,"decorator-cache-getter":1,"timers":35}],24:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31,"decorator-cache-getter":1}],26:[function(require,module,exports){
"use strict";
...
},{"../../utils/native-struct":31}],27:[function(require,module,exports){
"use strict";
...
},{"../utils/console":30,"./utils":28}],28:[function(require,module,exports){
"use strict";
...
},{"../utils/console":30,"../utils/native-struct":31}],29:[function(require,module,exports){
"use strict";
...
},{"./il2cpp":6}],30:[function(require,module,exports){
"use strict";
...
},{"decorator-cache-getter":1,"timers":35,"versioning":36}],33:[function(require,module,exports){
"use strict";
...
},{"./console":30,"fastest-levenshtein":2}],34:[function(require,module,exports){
...
Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.hook_libil2cpp = void 0;

const e = t(require("../logger"));

function a(t) {
  let a = "log_dbg_int", n = 47485339;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], i = t[1], s = o(n);
      e.default.INFO(a, "params : ", {
        str_msg: s,
        method: i
      });
    },
...
function o(t) {
  let e = t.add(8), a = e.readInt();
  return e = e.add(4), e.readUtf16String(a);
}

function i(t) {
  let a = "log_dbg_obj2", n = 47485734;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(n) {
      let i = n[0], s = n[1], d = n[2], f = o(i), r = o(s);
      if (e.default.INFO(a, "params : ", {
        message: i,
        tag: s,
        method: d,
        str_msg: f,
        str_tag: r
      }), f && (f.indexOf("Http") >= 0 || f.indexOf("https://game.trainstation2.com/login") >= 0)) {
        let n = Thread.backtrace(this.context, Backtracer.ACCURATE).map(DebugSymbol.fromAddress);
        e.default.TRACE(a, "base addr : " + t, n);
      }
    },
    onLeave: function(t) {}
  });
...
function s(t) {
  let a = "login", n = 47485734;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      e.default.INFO(a, "called - onEnter");
    },
    onLeave: function(t) {
      e.default.INFO(a, "called - onLeave");
    }
  });
}

function d(t) {
  if (!t || t.equals(ptr("0x00"))) return;
  let a = t, n = null, i = a.readPointer();
  a = a.add(4);
  let s = a.readPointer();
  a = a.add(4), n = a.readPointer();
  let d = o(n);
  a = a.add(4), n = a;
  let f = "";
  switch (n.readInt()) {
  ...
  a = a.add(4), n = a;
  let u = n.readInt();
  a = a.add(4), e.default.INFO("parse_req_data", "RequestData", {
    instance: i,
    monitor: s,
    url: d,
    method: f,
...
function f(t) {
  ...
  e.default.INFO(a, "start to hook", {
    ...
    onEnter: function(t) {
      e.default.INFO(a, "called - onEnter");
      let n = t[0], o = t[1], i = t[2], s = t[3], f = t[4];
      e.default.INFO(a, "params : ", {
        sender: n,
        requestData: o,
        maxRetryCount: i,
        token: s,
        method: f
      }), e.default.DUMP(a, "requestData", hexdump(o.readPointer(), {
        offset: 0,
        length: 160,
        header: !0,
        ansi: !1
...
function h(t) {
  ...
  e.default.INFO(a, "start to hook", {
    ...
    onEnter: function(t) {
      e.default.INFO(a, "called - onEnter");
      let n = t[0], i = t[1], s = t[2], d = t[3];
      e.default.INFO(a, "params : ", {
        data: n,
        name: i,
        value: s,
        method: d
      }), e.default.INFO(a, "name", {
        name: o(i)
      }), e.default.INFO(a, "value", {
        value: o(s)
      });
    },
    onLeave: function(t) {
...
function u(t) {
  let a = "HttpAddHeader", n = 21794799;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
...
function l(t) {
  let a = "IO.Mem.Write", n = 41790702;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.instance = t[0], this.buffer = t[1], this.offset = t[2], this.count = t[3].toInt32(), 
      this.method = t[4], e.default.INFO(a, "onEnter - params : ", {
        instance: this.instance,
        buffer: this.buffer,
        offset: this.offset,
        count: this.count,
        method: this.method
      }), e.default.DUMP(a, "buffer", hexdump(this.buffer.add(16), {
        offset: 0,
        length: Math.min(this.count, 64),
        header: !0,
        ansi: !1
      }));
    },
...
function c(t) {
  let a = "StreamContent", n = 21762129;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2], s = t[4];
      e.default.INFO(a, "onEnter - params : ", {
        instance: n,
        stream: o,
        context: i,
        method: s
...
function m(t) {
  let a = "SendRequest", n = 12124654;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2], s = t[3], d = t[4];
      e.default.INFO(a, "onEnter - params : ", {
        instance: n,
        redirecting: o,
        buffer: i,
        cancel: s,
        method: d
      }), e.default.DUMP(a, "instance", hexdump(n, {
        offset: 0,
        length: Math.min(64, 64),
        header: !0,
        ansi: !1
      }));
    },
...
function _(t) {
  let a = "MonoRequest", n = 21734e3;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2];
      e.default.INFO(a, "onEnter - params : ", {
        instance: n,
        obj: o,
        method: i
        ...
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "obj", hexdump(o, {
        offset: 0,
        length: Math.min(64, 64),
        header: !0,
        ansi: !1
...
function p(t) {
  let a = "send", n = 4194016;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2].toInt32(), s = t[3];
      e.default.INFO(a, "onEnter - params : ", {
        fd: n,
        buf: o,
        len: i,
...
function b(t) {
  let a = "deserialize", n = 17830922;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.unity_object = t[0], this.serialization_data = t[1], this.deserialization_context = t[2], 
      this.method = t[3], e.default.INFO(a, "onEnter - params : ", {
        unity_object: this.unity_object,
        serialization_data: this.serialization_data,
        deserialization_context: this.deserialization_context,
        method: this.method
      });
    },
    onLeave: function(t) {
      e.default.INFO(a, "onLeave - params : ", {
        unity_object: this.unity_object,
        serialization_data: this.serialization_data,
        deserialization_context: this.deserialization_context,
        method: this.method
...
function I(t) {
  let a = "serialize", n = 17831175, o = 64;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.unity_object = t[0], this.serialization_data = t[1], this.serializeUnityFields = t[2], 
      this.serialization_context = t[3], this.method = t[4], e.default.INFO(a, "onEnter - params : ", {
        unity_object: this.unity_object,
        serialization_data: this.serialization_data,
        serializeUnityFields: this.serializeUnityFields,
        serialization_context: this.serialization_context,
        method: this.method
      }), e.default.DUMP(a, "unity_object", hexdump(this.unity_object, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "serialization_data", hexdump(this.serialization_data, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "serializeUnityFields", hexdump(this.serializeUnityFields, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "serialization_context", hexdump(this.serialization_context, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
...
function F(t) {
  let a = "req_msg_dispose", n = 21759552, o = 64;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      ...
      e.default.INFO(a, "onEnter - params : ", {
        ...
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "instance", hexdump(n.readPointer(), {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      }));
      let s = n.readPointer(), d = s.add(0), f = s.add(4).readInt(), r = s.add(8), h = s.add(12), u = s.add(16).readS8(), l = s.add(20);
      e.default.INFO(a, "System_Net_Http_HttpRequestMessage_Fields", {
        headers: d,
        method: f,
        version: r,
        uri: h,
        is_used: u,
        content: l
      }), e.default.DUMP(a, "headers", hexdump(d, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "version", hexdump(r, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "uri", hexdump(h, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
      })), e.default.DUMP(a, "content", hexdump(l, {
        offset: 0,
        length: o,
        header: !0,
        ansi: !1
...
function O(t) {
  let a = "WebReqStream", n = 53544685;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2].toInt32(), s = t[3].toInt32(), d = t[4], f = t[5];
      e.default.INFO(a, "onEnter - params : ", {
        instance: n,
        buffer: o,
        offset: i,
        ...
        cancel: d,
        method: f
      }), e.default.DUMP(a, "buffer", hexdump(o, {
        offset: 0,
        length: s,
        header: !0,
        ansi: !1
...
function N(t) {
  let a = "SSL_Read", n = 52805668;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.instance = t[0], this.buffer = t[1], this.offset = t[2].toInt32(), this.count = t[3].toInt32(), 
      this.method = t[4], e.default.INFO(a, "onEnter - params : ", {
        instance: this.instance,
        buffer: this.buffer,
        offset: this.offset,
        count: this.count,
        method: this.method
      }), e.default.DUMP(a, "buffer", hexdump(this.buffer, {
        offset: 0,
        length: 64,
        header: !0,
        ansi: !1
...
function x(t) {
  let a = "SSL_AsyncRead", n = 52805836;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.instance = t[0], this.buffer = t[1], this.offset = t[2].toInt32(), this.count = t[3].toInt32(), 
      this.cancel = t[4], this.method = t[5], e.default.INFO(a, "onEnter - params : ", {
        instance: this.instance,
        buffer: this.buffer,
        offset: this.offset,
        count: this.count,
...
function E(t) {
  let a = "SSL_AsyncWrite", n = 52805923;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
...
function z() {
  let t = "hook_libil2cpp", o = Module.findBaseAddress("libil2cpp.so");
  e.default.INFO(t, "base address", {
    addr: o
  }), o ? (a(o), n(o), i(o), f(o), u(o), m(o), l(o), c(o), p(o), F(o), O(o), N(o), 
  g(o), x(o), E(o), b(o), I(o)) : e.default.ERROR(t, "Failed to find base address of libgame.so");
}

exports.hook_libil2cpp = z;

},{"../logger":39}],38:[function(require,module,exports){
"use strict";
...
function n(e, n) {
  let d = "android_dlopen_ext", o = null, l = 0;
  o = Module.findExportByName(null, "android_dlopen_ext"), o ? (t.default.INFO(d, "Found android_dlopen_ext", {
    addr: o
  }), Interceptor.attach(o, {
    onEnter: function(n) {
      if (n) {
        let o = n[0].readUtf8String();
        o && (t.default.INFO(d, "load : " + o), o.indexOf("lib_burst_generated.so") >= 0 && (t.default.INFO(d, "onEnter libil2cpp.so"), 
        l = 1, e(this, n)));
      }
    },
    onLeave: function(e) {
      l && (l = 0, t.default.INFO(d, "onLeave libil2cpp.so"), n(this, e));
    }
  })) : t.default.ERROR(d, "Failed to find android_dlopen_ext", {
    addr: o
  });
}

function d(e, n) {
  let d = "hook_dlopen", o = null;
  o = Module.findExportByName(null, "dlopen"), o ? (t.default.INFO(d, "Found dlopen", {
    addr: o
  }), Interceptor.attach(o, {
    onEnter: function(n) {
      if (n) {
        let o = n[0].readUtf8String();
        o && (t.default.INFO(d, "load : " + o), o.indexOf("libil2cpp.so") >= 0 && (t.default.INFO(d, "onEnter libil2cpp.so"), 
        e(this, n)));
      }
    },
    onLeave: function(e) {}
  })) : t.default.ERROR(d, "Failed to find dlopen", {
    addr: o
  });
}

const o = {
  android_dlopen_ext: n,
  hook_dlopen: d
};
...
class a {
  static _SEND(e, a, s, d) {
    let r = {
      thread_id: Process.getCurrentThreadId(),
      log_level: e,
      function: a && a.length > t ? a.substr(0, t) : a,
      msg: s,
      data: d
    };
    send(r);
...
const a = e(require("./hooks/module")), i = require("./hooks/libil2cpp");
...
function r() {
  t.default.INFO("UNITY VERSION", " : " + Il2Cpp.unityVersion), Il2Cpp.trace().domain().filterClasses((e => e.name.toLowerCase().indexOf("maincontext") >= 0)).filterMethods((e => e.name.toLowerCase().indexOf("servertime") < 0 && e.name.toLowerCase().indexOf("tickupdate") < 0)).and().attach("detailed"), 
  Il2Cpp.trace().domain().filterClasses((e => e.name.toLowerCase().indexOf("backend") >= 0 && e.name.toLowerCase().indexOf("loginresponse") >= 0)).and().attach("detailed"), 
  Il2Cpp.trace().domain().filterClasses((e => e.name.toLowerCase().indexOf("backend") >= 0 && e.name.toLowerCase().indexOf("initialdata") >= 0)).and().attach("detailed");
}

function d(e, a) {
  for (let e = 0; e < 0; e++) t.default.DEBUG("onload libil2cpp.so", "sleep " + (e + 1) + " / 30"), 
  Thread.sleep(1);
  (0, i.hook_libil2cpp)();
}

Java.perform((function() {
  a.default.android_dlopen_ext(o, d);
}));

},{"./hooks/libil2cpp":37,"./hooks/module":38,"./logger":39,"frida-il2cpp-bridge":29}]},{},[40])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
