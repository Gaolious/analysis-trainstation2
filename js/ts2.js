...
function i(t) {
  let e = t.add(12), a = e.readInt();
  return e = e.add(4), e.readCString(a);
}

function d(t) {
  let a = "log_dbg_obj2", n = 51137725;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], i = t[1], d = t[2], s = o(n), r = o(i);
      e.default.INFO(a, "params : ", {
        message: n,
        tag: i,
        method: d,
...
function f(t) {
  ...
  e.default.INFO(a, "start to hook", {
    ...
    onEnter: function(t) {
      e.default.INFO(a, "called - onEnter");
      let n = t[0], o = t[1], i = t[2], d = t[3], s = t[4];
      e.default.INFO(a, "params : ", {
        sender: n,
        requestData: o,
        maxRetryCount: i,
...
function h(t) {
  let a = "HttpAddHeader", n = 21921979;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
...
function c(t) {
  ...
  e.default.INFO(a, "start to hook", {
    ...
    onEnter: function(t) {
      ...
      this.method = t[4], 1573143 != this.buffer.add(16).readInt() && e.default.INFO(a, this.buffer.add(16).readCString(this.count), {});
    },
    onLeave: function(t) {}
  });
}
...
function I(t) {
  let a = "StreamContent", n = 21889309;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2], d = t[4];
...
function b(t) {
  let a = "send", n = 54747054;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2].toInt32(), d = t[3];
      e.default.INFO(a, "onEnter - params : ", {
        fd: n,
        buf: o,
        len: i,
...
function p(t) {
  let a = "serialize", n = 17961882, o = 64;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
...
function F(t) {
  let a = "WebReqStream", n = 54659481;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      let n = t[0], o = t[1], i = t[2].toInt32(), d = t[3].toInt32(), s = t[4], r = t[5];
      e.default.INFO(a, "onEnter - params : ", {
        instance: n,
        buffer: o,
        offset: i,
        ...
        cancel: s,
        method: r
      }), e.default.INFO(a, "buffer : ", {
        buffer: o.add(16).readCString(d)
      });
    },
    onLeave: function(t) {}
  });
...
function g(t) {
  let a = "SSL_AsyncRead", n = 53920632;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
...
function E(t) {
  let a = "SSL_AsyncWrite", n = 54023992;
  e.default.INFO(a, "start to hook", {
    base_addr: t,
    offset: n
  }), Interceptor.attach(t.add(n), {
    onEnter: function(t) {
      this.instance = t[0], this.buffer = t[1], this.offset = t[2].toInt32(), this.count = t[3].toInt32(), 
      this.cancel = t[4], this.method = t[5], e.default.INFO(a, this.buffer.add(16).readCString(this.count), {});
    },
    onLeave: function(t) {
      return t;
    }
...
function v() {
  ...
  e.default.INFO(t, "base address", {
    addr: o
  }), o ? (a(o), n(o), d(o), c(o), N(o), E(o)) : e.default.ERROR(t, "Failed to find base address of libgame.so");
}

exports.hook_libil2cpp = v;
...
function l() {
  t.default.INFO("Android Id ", Java.use("android.provider.Settings$Secure").getString(d(), "android_id"));
}

function s(e, a) {
  for (let e = 0; e < 0; e++) t.default.DEBUG("onload libil2cpp.so", "sleep " + (e + 1) + " / 30"), 
  Thread.sleep(1);
  (0, i.hook_libil2cpp)(), l(), Il2Cpp.dump();
}

Java.perform((function() {
  a.default.android_dlopen_ext(n, s);
}));

},{"./hooks/libil2cpp":37,"./hooks/module":38,"./logger":39,"frida-il2cpp-bridge":29}]},{},[40])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
